/**
 * LoginForm Component - Shadcn Style
 * 
 * Clean, minimal login with email/password and Google OAuth.
...
const LoginForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (userId) {
                ...
                // Redirect based on role (unless there's a specific "from" location)
                if (from) {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            // Note: Google OAuth redirects to callback URL, so no navigation needed here
        } catch (err) {
            setError(err.message || 'An unexpected error occurred');
        } finally {
